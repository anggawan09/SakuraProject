            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table style="margin-bottom: 10px">
                        <tr>
                            <td>
                                <button class="btn btn-success" onclick="add_berita()"><i class="glyphicon glyphicon-plus"></i> Add berita</button>
                ...
                function edit_berita(id)
                {
                    ...
                    $.ajax({
                        ...
                        {   
                            ...
                            $('[name="slug_berita"]').val(data.slug_berita);
                            $('[name="judul_berita"]').val(data.judul_berita);
                            $('[name="status_berita"]').val(data.status_berita);
                            ...
                            if(data.photo)
                            {
                                ...
                                $('#photo-preview div').html('<img src="'+base_url+'upload/berita/'+data.photo+'" class="img-responsive">'); // show photo
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <center><h3 class="modal-title">Form Berita</h3></center>
                        </div>
                        <div class="modal-body form">
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <div class="form-body" style="width: 100%">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select name="kategori" class="form-control">
                                                <option value="">--Select Kategori Galeri--</option>
                                   ...
                                   <div class="form-group">
                                        <label class="control-label col-md-3">Status Berita</label>
                                        <div class="col-md-9">
