            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table style="margin-bottom: 10px">
                        <tr>
                            <td>
                                <button class="btn btn-success" onclick="add_galeri()"><i class="glyphicon glyphicon-plus"></i> Add Galeri</button>
                    ...
                    $.ajax({
                        ...
                        success: function(data)
                        {
                            ...
                            if(data.photo)
                            {
                                ...
                                $('#photo-preview div').html('<img src="'+base_url+'upload/galeri/'+data.photo+'" class="img-responsive">'); // show photo
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <center><h3 class="modal-title">Form galeri</h3></center>
                        </div>
