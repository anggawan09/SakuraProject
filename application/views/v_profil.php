                ...
                function edit_profil(id)
                {
                    ...
                    $.ajax({
                        ...
                        {   
                            ...
                            $('[name="status_profile"]').val(data.status_profile);
                            ...
                            if(data.photo)
                            {
                                ...
                                $('#photo-preview div').html('<img src="'+base_url+'upload/profil/'+data.photo+'" class="img-responsive">'); // show photo
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <center><h3 class="modal-title">Form profil</h3></center>
                        </div>
                        <div class="modal-body form">
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <div class="form-body" style="width: 100%">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select name="jenis" class="form-control">
                                                <option value="">--Select Jenis Profile--</option>
                                   ...
                                   <div class="form-group">
                                        <label class="control-label col-md-3">Status profil</label>
                                        <div class="col-md-9">
                                            <select name="status_profile" class="form-control">
