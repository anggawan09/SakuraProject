            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table style="margin-bottom: 10px">
                        <tr>
                            <td>
                                <button class="btn btn-success" onclick="add_surat_masuk()"><i class="glyphicon glyphicon-plus"></i> Add Surat Masuk</button>
            ...
            <script type="text/javascript">
                ...
                function add_surat_masuk()
                {
                    ...
                    $('.modal-title').text('Add surat_masuk'); // Set Title to Bootstrap modal title
                ...
                function edit_surat_masuk(id)
                {
                    ...
                    $.ajax({
                        url : "<?php echo site_url('surat_masuk/ajax_edit')?>/" + id,
                        type: "GET",
                        dataType: "JSON",
                        success: function(data)
                        {
                            ...
                            $('.modal-title').text('Edit surat_masuk'); // Set title to Bootstrap modal title
                            ...
                            if(data.photo)
                            {
                                ...
                                $('#photo-preview div').html('<img src="'+base_url+'upload/suratmasuk/'+data.photo+'" class="img-responsive">'); // show photo
                ...
                function delete_surat_masuk(id)
                {
                    if(confirm('Are you sure delete this data?'))
                    {
                        ...
                        $.ajax({
                            url : "<?php echo site_url('surat_masuk/ajax_delete')?>/"+id,
                            type: "POST",
                            dataType: "JSON",
                            success: function(data)
                            {
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <center><h3 class="modal-title">Form surat_masuk</h3></center>
                        </div>
                            ...
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <div class="form-body" style="width: 100%">
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Instansi Pengirim</label>
                                        <div class="col-md-9">
                                            <input name="pengirim" placeholder="Instansi Pengirim" class="form-control" type="text">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Tanggal Penerimaan Surat</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="perihal" placeholder="Keterangan" class="form-control"></textarea>
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
